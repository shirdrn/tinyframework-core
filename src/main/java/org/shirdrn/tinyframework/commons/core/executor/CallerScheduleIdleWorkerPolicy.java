...
public class CallerScheduleIdleWorkerPolicy extends Configured implements RejectedExecutionHandler {
	...
	public void setReadableContext(ReadableContext readableContext) {
		...
		this.workQueueSize = readableContext.getInt("commons.core.thread.pool.workQueueSize", 1);
		this.checkIdleWorkerInterval = readableContext.getInt("commons.core.thread.pool.checkIdleWorkerInterval", 1000);
	}
